"""autogenerated by genpy from find_present_in_room/Tags.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import find_present_in_room.msg
import std_msgs.msg

class Tags(genpy.Message):
  _md5sum = "9fd9ccebe014b769dcb84bc4557ac837"
  _type = "find_present_in_room/Tags"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint32','float64','uint32','find_present_in_room/Tag[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = find_present_in_room.msg.Tag()
        _x = val1
        start = end
        end += 84
