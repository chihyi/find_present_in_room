...
(cl:defclass <Tags> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tags
    :reader tags
    :initarg :tags
    :type (cl:vector find_present_in_room-msg:Tag)
   :initform (cl:make-array 0 :element-type 'find_present_in_room-msg:Tag :initial-element (cl:make-instance 'find_present_in_room-msg:Tag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Tags>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tags)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name find_present_in_room-msg:<Tags> is deprecated: use find_present_in_room-msg:Tags instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_present_in_room-msg:header-val is deprecated.  Use find_present_in_room-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_width-val :lambda-list '(m))
(cl:defmethod image_width-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_present_in_room-msg:image_width-val is deprecated.  Use find_present_in_room-msg:image_width instead.")
  (image_width m))

(cl:ensure-generic-function 'image_height-val :lambda-list '(m))
(cl:defmethod image_height-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_present_in_room-msg:image_height-val is deprecated.  Use find_present_in_room-msg:image_height instead.")
  (image_height m))

(cl:ensure-generic-function 'angle_of_view-val :lambda-list '(m))
(cl:defmethod angle_of_view-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_present_in_room-msg:angle_of_view-val is deprecated.  Use find_present_in_room-msg:angle_of_view instead.")
  (angle_of_view m))

(cl:ensure-generic-function 'tag_count-val :lambda-list '(m))
(cl:defmethod tag_count-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_present_in_room-msg:tag_count-val is deprecated.  Use find_present_in_room-msg:tag_count instead.")
  (tag_count m))

(cl:ensure-generic-function 'tags-val :lambda-list '(m))
(cl:defmethod tags-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_present_in_room-msg:tags-val is deprecated.  Use find_present_in_room-msg:tags instead.")
  (tags m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Tags>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tags)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'find_present_in_room-msg:Tag))
